...
public class MaximumVisitCountPathFinderTest extends TestCase {
    private Graph<String> testData;

    public void test1() {
        PathFinder<String> pathFinder = new MaximumVisitCountPathFinder<String>(testData(), 1);
    ...
    public void test2() {
        PathFinder<String> pathFinder = new MaximumVisitCountPathFinder<String>(testData(), 2);
        int result = pathFinder.paths("A", "B").size();
        //A -> B
        //A -> E -> B
    ...
    public void test4() {
        PathFinder<String> pathFinder = new MaximumVisitCountPathFinder<String>(testData(), 4);
        int result = pathFinder.paths("A", "B").size();
        //A -> B
        //A -> E -> B
        //A -> D -> E -> B
    ...
    public void test5() {
        PathFinder<String> pathFinder = new MaximumVisitCountPathFinder<String>(testData(), 5);
        int result = pathFinder.paths("A", "B").size();
        //A -> B
        //A -> E -> B
        //A -> D -> E -> B
    ...
    public void test6() {
        PathFinder<String> pathFinder = new MaximumVisitCountPathFinder<String>(testData(), 6);
        int result = pathFinder.paths("A", "B").size();
        //A -> B
        //A -> E -> B
        //A -> D -> E -> B
